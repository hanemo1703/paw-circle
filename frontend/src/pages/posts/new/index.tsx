      ...
      <form onSubmit={onSubmit}>
                ...
                <tbody>
                  {petFields.map((field, index) => {
                    ...
                    return (
                      <tr key={field.id}>
                        <td>
                          <select {...register(`pets.${index}.species`)}>
                            {SPECIES_OPTIONS.map((s) => (
                              <option key={s} value={s}>
                                {SPECIES_LABEL[s]}
                              </option>
                        ...
                        <td>
                          <select {...register(`pets.${index}.gender`)}>
                            {GENDER_OPTIONS.map((g) => (
                              <option key={g} value={g}>
                                {GENDER_LABEL[g]}
                              </option>
        ...
        <div className={styles.field}>
          ...
          <div className={styles.regionRow}>
            <select id="province" {...register('provinceCode')}>
            ...
            <select id="ward" disabled={!provinceCode} {...register('wardCode')}>
